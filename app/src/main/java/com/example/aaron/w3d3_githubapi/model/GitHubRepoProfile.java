...
package com.example.aaron.w3d3_githubapi.model;
...
public class GitHubRepoProfile implements Parcelable {
    ...
    protected GitHubRepoProfile(Parcel in) {
        name = in.readString();
    ...
    public static final Creator<GitHubRepoProfile> CREATOR = new Creator<GitHubRepoProfile>() {
        @Override
        public GitHubRepoProfile createFromParcel(Parcel in) {
            return new GitHubRepoProfile(in);
        }

        @Override
        public GitHubRepoProfile[] newArray(int size) {
            return new GitHubRepoProfile[size];
        }
    };
